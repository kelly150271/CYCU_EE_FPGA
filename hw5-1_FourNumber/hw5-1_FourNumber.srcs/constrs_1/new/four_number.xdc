...
#set_property PACKAGE_PIN U1 [get_ports {sw[13]}]
	#set_property IOSTANDARD LVCMOS33 [get_ports {swe[13]}]
...
set_property PACKAGE_PIN U2 [get_ports {display4[3]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {display4[3]}]
set_property PACKAGE_PIN U4 [get_ports {display4[2]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {display4[2]}]
set_property PACKAGE_PIN V4 [get_ports {display4[1]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {display4[1]}]
set_property PACKAGE_PIN W4 [get_ports {display4[0]}]
