...
set_property PACKAGE_PIN U8 [get_ports {out_seg[2]}]
...
set_property PACKAGE_PIN U5 [get_ports {out_seg[4]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {out_seg[4]}]
set_property PACKAGE_PIN V5 [get_ports {out_seg[5]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {out_seg[5]}]
set_property PACKAGE_PIN U7 [get_ports {out_seg[6]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {out_seg[6]}]

set_property PACKAGE_PIN V7 [get_ports {out_seg[7]}]							
	set_property IOSTANDARD LVCMOS33 [get_ports {out_seg[7]}]

set_property PACKAGE_PIN U2 [get_ports display]
